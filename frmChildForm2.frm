VERSION 5.00
Begin VB.Form frmChildForm2 
   BackColor       =   &H00808080&
   BorderStyle     =   0  'None
   Caption         =   "Child Form 2"
   ClientHeight    =   3180
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4680
   ...
   Begin VB.PictureBox picTitle 
      ...
      Begin VB.PictureBox titleButton 
         ...
         Height          =   300
         Left            =   960
         Picture         =   "frmChildForm2.frx":0000
         ScaleHeight     =   20
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   20
         TabIndex        =   11
      ...
      Begin VB.PictureBox titleRight 
         ...
         Height          =   300
         Left            =   1440
         Picture         =   "frmChildForm2.frx":04F2
         ScaleHeight     =   20
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   3
         TabIndex        =   10
      ...
      Begin VB.PictureBox titleBack 
         ...
         Height          =   300
         Left            =   960
         Picture         =   "frmChildForm2.frx":0624
         ScaleHeight     =   20
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   1
         TabIndex        =   9
      ...
      Begin VB.PictureBox titleButton2 
         ...
         Height          =   300
         Left            =   1080
         Picture         =   "frmChildForm2.frx":06B6
         ScaleHeight     =   20
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   20
         TabIndex        =   8
      ...
      Begin VB.PictureBox picMin 
         ...
         Height          =   300
         Left            =   360
         Picture         =   "frmChildForm2.frx":0BA8
         ScaleHeight     =   20
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   20
         TabIndex        =   7
      ...
      Begin VB.PictureBox picExit 
         ...
         Height          =   300
         Left            =   0
         Picture         =   "frmChildForm2.frx":109A
         ScaleHeight     =   20
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   20
         TabIndex        =   6
      ...
      Begin VB.PictureBox titleLeft 
         ...
         Height          =   300
         Left            =   0
         Picture         =   "frmChildForm2.frx":158C
         ScaleHeight     =   20
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   59
         TabIndex        =   5
      ...
      Begin VB.Image Image1 
         Height          =   300
         Left            =   2280
         Picture         =   "frmChildForm2.frx":23DE
         Top             =   0
         Width           =   45
      End
      Begin VB.Label lblTitle 
   ...
   End
End
Attribute VB_Name = "frmChildForm2"
